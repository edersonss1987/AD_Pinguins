...
Usaremos um dataset já disponivel no pacote seaborn, para analise de dados, tratamento dos variaves missing e treinamento do nosso modelo preditivo
A motivação desta Analise é descobrir o melhor modelo preditivo, onde possamos prever o peso de um Pinguin, dando as variáveis de sua espécie e seu Habitat.
Por isso, usaremos o pacote do Scikit Learn, de aprendizado de maquinas e com a ajuda da regressão linear seguiremos com as analises, realizando a padronização e normalização dos dados, avalização do melhor modelo e predição.. 
